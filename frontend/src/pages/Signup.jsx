...
const Signup = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const msg = err.response?.data?.message || JSON.stringify(err.response?.data?.errors) || 'Signup failed';
            setError(msg);
        } finally {
            setLoading(false);
        }
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50">
            <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8">
                ...
                <p className="text-center text-gray-500 mb-8">Join Booktures today</p>

                {error && (
                    <div className="bg-red-50 text-red-500 p-3 rounded-md text-sm mb-4 text-center break-words">
                        {error}
                    </div>
                )}
